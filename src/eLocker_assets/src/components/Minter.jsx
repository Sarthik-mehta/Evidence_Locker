...
function Minter() {
  ...
  async function onSubmit(data) {
    ...
    let newNFTID = await eLocker.mint(
      imageByteData,
  ...
  async function fetchUsers() {
    var usersList = await eLocker.getUsers();
    console.log("called");
    setUsers(usersList);
  }
  ...
  if (nftPrincipal == "") {
      ...
      <div
        ...
        <div className="" style={{ marginLeft: "60%" }}>
          ...
          <form
            ...
            noValidate=""
            autoComplete="off">
            <div className="upload-container" style={{ color: "black" }}>
              <input
            ...
            <h6 className="form-Typography-root makeStyles-subhead-102 form-Typography-subtitle1 form-Typography-gutterBottom">
              <b style={{ color: "black" }}>
                Share the case details with other users
              </b>
            </h6>
            <Autocomplete
              disablePortal
    ...
    return (
      <div className="minter-container">
        <h3
          className="Typography-root makeStyles-title-99 Typography-h3 form-Typography-gutterBottom"
          style={{ color: "white" }}>
